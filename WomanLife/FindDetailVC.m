...
@interface FindDetailVC ()
@property(nonatomic,strong)UIWebView *webView;
@property(nonatomic,strong)MBProgressHUD *hud;

@end

#define FindDetailUrl @"http://t.gexiaojie.com/index.php?m=mobile&c=explorer&a=article&aid="
...
- (void)viewDidLoad {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@",FindDetailUrl,_fModel.findID];
